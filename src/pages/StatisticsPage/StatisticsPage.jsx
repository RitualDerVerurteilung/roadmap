...
const StatisticsPage = () => {
    ...
    const calculateStatistics = () => {
        ...
        const statusData = [
            ...
            { name: 'В процессе', value: inProgress, color: '#6f1ef0' },
                        ...
                        <Paper sx={{ p: 3, height: 400, position: 'relative' }}>
                            ...
                            <ResponsiveContainer width="100%" height="90%">
                                <BarChart data={stats.categoryData} id="category-bar-chart">
                                    ...
                                    <Bar dataKey="inProgress" name="В процессе" fill="#6f1ef0" />
                        ...
                        <Paper sx={{ p: 3, height: 500 }}>
                            ...
                            <ResponsiveContainer width="100%" height="90%">
                                ...
                                >
                                    ...
                                    />
                                    <Legend />
                                    <Bar dataKey="completionRate" name="Процент выполнения" fill="#6019d2">
                                        {stats.categoryData.map((entry, index) => (
                                            <Cell
                                                key={`cell-${index}`}
                                                fill={entry.completionRate >= 80 ? '#4caf50' :
                                                    entry.completionRate >= 50 ? '#6019d2' :
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} sm={4}>
                                    <Paper sx={{ p: 2, bgcolor: 'rgba(124, 33, 243, 0.2)' }}>
